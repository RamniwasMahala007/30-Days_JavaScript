...
video.addEventListener('click', toggleplay); // click the vodeo to play
video.addEventListener('play', updateButton);// update the play button when the video plays
video.addEventListener('pause',updateButton);// update the play button when the video pause
